...
- [x] `/specflow.merge` pushes current branch to remote
...
- [x] `specflow state archive` is called after merge
...
- [x] Update is verified with `specflow roadmap status`
...
- [x] `/specflow.backlog` parses backlog items
...
- [x] `specflow roadmap backlog add "item"` works
...
- [x] Single `/specflow.merge` completes full workflow
...
- [x] `/specflow.backlog` shows item analysis
...
- [x] `specflow roadmap backlog add` executes in <2 seconds
- [x] `specflow roadmap backlog list` shows items
- [x] `specflow roadmap backlog clear` removes items
...
- [x] `commands/specflow.merge.md` exists and is valid
- [x] `commands/specflow.backlog.md` exists and is valid
- [x] `scripts/bash/specflow-roadmap.sh` updated with backlog command
