...
├── speckit-scaffold.sh  # MODIFY: Add --safe, --type, detection logic
└── speckit-doctor.sh    # MODIFY: Output optimization
...
print_summary() {
  ...
  local hint="$4"     # "Run /speckit.init to start interview"
...
1. Integrate detection into `speckit-scaffold.sh`
