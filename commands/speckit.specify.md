...
2. **Check for existing branches before creating new one**:
   ...
   d. Run `speckit feature create` with the calculated number and short-name:
   - Pass `--number N+1` and `--short-name "your-short-name"` along with the feature description
   - Example: `speckit feature create --json --number 5 --short-name "user-auth" "Add user authentication"`
